...
export interface AccountsEventResponse {
  'data'?: (_events_AccountEventResponse)[];
}

export interface AccountsEventResponse__Output {
  'data'?: (_events_AccountEventResponse__Output)[];
}
